...
class radio_Adapter: Adapter<radio_Adapter.ViewHolder>() {

    var radio_list = listOf<RadiosItem>()
    lateinit var viewBinding: RadioItemBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        viewBinding = RadioItemBinding.inflate(inflater,parent,false)
        return ViewHolder(viewBinding)
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        var item = radio_list[position]
        holder.viewBinding.tvRadio.text = item.name
        onItemClickPlay.let {
            holder.viewBinding.ivPlay.setOnClickListener {
                onItemClickPlay?.onItemClick(position, radio_list[position])
            }
        }
        onItemClickStop.let {
            holder.viewBinding.ivStop.setOnClickListener {
    ...
    inner class ViewHolder(var viewBinding: RadioItemBinding): RecyclerView.ViewHolder(viewBinding.root){
